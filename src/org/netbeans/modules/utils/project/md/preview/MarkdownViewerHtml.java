...
@MultiViewElement.Registration(
        ...
        iconBase = "org/netbeans/modules/utils/project/md/documentation/resources/markdown.png",
...
//    final HtmlRenderer renderer = HtmlRenderer.builder(OPTIONS).build();
    ...
    public JComponent getVisualRepresentation() {
        if (component == null) {
            ...
            viewer.setContentType("text/x-html");
    ...
    public void updateView() {
        if ((source != null) && (viewer != null)) {
            try {
                ...
                MdParserResult result = MdParser.getParserResult(dataObject.getPrimaryFile());
