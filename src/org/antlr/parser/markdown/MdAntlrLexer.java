...
public class MdAntlrLexer extends LexerAdaptor {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"BreakLine", "BOLD_START", "DoubleAsterix", "ITALIC", "SgAsterix", "CODE", 
			"BLOCK_CODE_START", "TriBacktick", "Backtick", "HYPER_LINK_LABEL", "HYPER_LINK", 
			"RAW_TEXT", "RawText", "BOLD_HYPER_LINK_LABEL", "BOLD_HYPER_LINK", "BOLD_END", 
			"BOLD_NL", "BOLD", "SINGLE_PAR", "LANG_TYPE", "BLOCK_CODE", "BLOCK_CODE_END", 
			"BLOCK_CODE_ESCAPE"
		};
	}
