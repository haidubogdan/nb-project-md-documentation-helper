...
public class MdAntlrParser extends Parser {
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 98288L) != 0) );
			setState(35);
			match(EOF);
			}
		}
	...
	public final LineContext line() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 98096L) != 0) );
			setState(47);
			_la = _input.LA(1);
			if ( !(_la==EOF || _la==NL) ) {
	...
	public static class TextEffectContext extends ParserRuleContext {
		...
		public TerminalNode STRIKETHROUGH() { return getToken(MdAntlrParser.STRIKETHROUGH, 0); }
